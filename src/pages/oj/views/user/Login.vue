  ...
  export default {
    ...
    data () {
      ...
      return {
        ...
        ruleLogin: {
          username: [
            {required: true, trigger: 'blur', message: '닉네임을 입력해 주세요.'},
            {validator: CheckRequiredTFA, trigger: 'blur'}
          ],
          password: [
            {required: true, trigger: 'change', message: '비밀번호를 입력해 주세요.'},
            {min: 6, max: 20, trigger: 'change', message: '비밀번호는 6자 이상 20자 이하로 입력해 주세요.'}
          ]
        }
      }
    },
